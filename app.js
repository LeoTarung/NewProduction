...
io.on("connection", (socket) => {
    ...
    function AmbilDariDB(){
        ...
        connection.query("SELECT * FROM db_mesincasting WHERE material='HD-2'", (err, res) => {
            socket.emit("MesinCastingHD-2", res);
        });
        connection.query("SELECT * FROM db_mesincasting WHERE material='HD-4'", (err, res) => {
            socket.emit("MesinCastingHD-4", res);
        });
        connection.query("SELECT * FROM db_mesincasting WHERE material='ADC12'", (err, res) => {
            socket.emit("MesinCastingADC12", res);
        });
        connection.query("SELECT * FROM db_mesincasting WHERE material='YH3R'", (err, res) => {
