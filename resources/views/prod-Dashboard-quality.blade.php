...
@section('content')
    ...
    <div class="row">
        <div class="col">
            <a class="btn btn-sm btn-primary mb-2 float-start me-2" href="{{ url('/tv/quality/diesapproval') }}"
                target="_blank"><i class="fa-solid fa-tv"></i> Monitoring Dies Approval</a>
            <a class="btn btn-sm btn-secondary mb-2 float-start me-2" href="{{ url('/tv/quality/kalibrasi') }}"
                target="_blank"><i class="fa-solid fa-tv"></i> Monitoring Achivement Kalibrasi</a>
            <a class="btn btn-sm btn-warning mb-2 float-start me-2" href="{{ url('/tv/quality/spectro') }}"
                target="_blank"><i class="fa-solid fa-tv"></i> Monitoring Spectrometer Test</a>
        </div>
    </div>
    {{-- <div class="row">
    <div class="col">
            ...
            <div class="card-body">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="pills-Measurement-Part-tab" data-bs-toggle="pill"
                            data-bs-target="#pills-Measurement-Part" type="button" role="tab"
                            aria-controls="pills-Measurement-Part" aria-selected="false" Measurement-Part>Measurement
                            Part</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-achivement-kalibrasi-tab" data-bs-toggle="pill"
                            data-bs-target="#pills-achivement-kalibrasi" type="button" role="tab"
                            aria-controls="pills-achivement-kalibrasi" aria-selected="true">Achivement Kalibrasi</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-DiesApproval-tab" data-bs-toggle="pill"
                            data-bs-target="#pills-DiesApproval" type="button" role="tab"
                            aria-controls="pills-DiesApproval" aria-selected="false">Dies Approval</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-SpectroHPDC-tab" data-bs-toggle="pill"
                            data-bs-target="#pills-SpectroHPDC" type="button" role="tab"
                            aria-controls="pills-SpectroHPDC" aria-selected="false">Spectro HPDC</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-SpectroGDC-tab" data-bs-toggle="pill"
                            data-bs-target="#pills-SpectroGDC" type="button" role="tab"
                            aria-controls="pills-SpectroGDC" aria-selected="false" SpectroGDC>Spectro GDC</button>
                    </li>
                </ul>
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade  show active" id="pills-Measurement-Part" role="tabpanel"
                        aria-labelledby="pills-Measurement-Part-tab">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header fw-bold font-monospace fs-5"><i class="fa-solid fa-paste"></i>
                                    Measurement Part
                                    <button class="btn btn-success mb-2 float-end" onclick="AddMeasurement()"><i
                                            class="fa-solid fa-plus"></i> Measurement</button>
                                    <button class="btn btn-warning mb-2 float-end me-2" onclick="Measurement()"><i
                                            class="fa-solid fa-cubes-stacked"></i> Measurement Ticket</button>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="Table_Measurement"
                    ...
                    <div class="tab-pane fade" id="pills-achivement-kalibrasi" role="tabpanel"
                        aria-labelledby="pills-achivement-kalibrasi-tab" tabindex="0">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header fw-bold font-monospace fs-5"><i class="fa-solid fa-paste"></i>
                                    Achivement Kalibrasi Today
                                    <button class="btn btn-success mb-2 float-end" onclick="AddKalibrasi()"><i
                                            class="fa-solid fa-plus"></i> Kalibrasi</button>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="Table_AchKalibrasi"
                                            class="table table-striped-columns table-hover table-bordered nowrap display  w-100"
                                            style="overflow-x: scroll">
                                            <thead>
                                                <tr>
                    ...
                    <div class="tab-pane fade" id="pills-DiesApproval" role="tabpanel"
                        aria-labelledby="pills-DiesApproval-tab" tabindex="0">
                        <div class="col-12 mt-3">
                            <div class="card">
                                <div class="card-header fw-bold font-monospace fs-5"><i
                                        class="fa-solid fa-check-double"></i> Dies Approval Today
                                    <button class="btn btn-success mb-2 float-end" onclick="AddDiesApproval()"><i
                                            class="fa-solid fa-plus"></i> Dies Approval</button>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="Table_DiesApproval"
                                            class="table table-striped-columns table-hover table-bordered display w-100"
                                            style="overflow-x: scroll">
                                            <thead>
                                                <tr>
                    ...
                    <div class="tab-pane fade" id="pills-SpectroHPDC" role="tabpanel"
                        aria-labelledby="pills-SpectroHPDC-tab" tabindex="0">
                        <div class="col-12 mt-3">
                            <div class="card">
                                <div class="card-header fw-bold font-monospace fs-5"><i class="fa-solid fa-paste"></i>
                                    Spectrometer HPDC
                                    <button class="btn btn-success mb-2 float-end" onclick="AddSpectroHPDC()"><i
                                            class="fa-solid fa-plus"></i> Spectro HPDC</button>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="Table_SpectroHPDC"
                                            class="table table-striped-columns table-hover table-bordered nowrap display  w-100"
                                            style="overflow-x: scroll">
                                            <thead>
                                                <tr>
                    ...
                    <div class="tab-pane fade" id="pills-SpectroGDC" role="tabpanel"
                        aria-labelledby="pills-SpectroGDC-tab" tabindex="0">
                        <div class="col-12 mt-3">
                            <div class="card">
                                <div class="card-header fw-bold font-monospace fs-5"><i class="fa-solid fa-paste"></i>
                                    Spectrometer GDC
                                    <button class="btn btn-success mb-2 float-end" onclick="AddSpectroGDC()"><i
                                            class="fa-solid fa-plus"></i> Spectro GDC</button>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="Table_SpectroGDC"
                                            class="table table-striped-columns table-hover table-bordered nowrap display w-100"
                                            style="overflow-x: scroll">
                                            <thead>
                                                <tr>
            ...
            var table = $('#Table_DiesApproval').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        name: 'status_pengukuran'
                    },
                    {
                        data: 'sample_approval',
                    ...
                    {
                        data: 'status_submit_sample',
                        name: 'status_submit_sample'
                    },
                    {
                        data: 'status_submit_pa',
                        name: 'status_submit_pa'
                    },
                    {
                        data: 'status_submit_ipp',
                        name: 'status_submit_ipp'
                    },
                    {
                        data: 'status_submit_masspro',
                        name: 'status_submit_masspro'
                    },
                    {
                        data: 'action',
                        name: 'action',
    ...
    <script>
        function Measurement() {
            $.get('/prod/modal-quality/measurement/table', {}, function(data, status) {
                ...
                dropdownParent: $("#staticBackdrop") //untuk membuat selct 2 bisa di search
            ...
            $.get('/prod/modal-quality/measurement', {}, function(data, status) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $("form").attr("action",
                            "{{ url('/prod/modal-quality/measurement/update') }}");
        ...
        function mesinCMM(id, cmm) {
            // var cmmValue = $("#mesinCMM").val();
            console.log(cmm);
            $.ajax({
                method: "POST",
                dataType: "json",
                url: "/prod/modal-quality/measurement/update/cmm" + '/' + id,
                data: {
                    _token: "{{ csrf_token() }}",
                    id: id,
                    value: cmm
                ...
                success: function(data) {
                    console.log('CMM berhasil DiUpdate')
                },
            });
        }

        function AksiJudgement(id, judgement) {
            $.ajax({
                method: "POST",
                dataType: "json",
                url: "/prod/modal-quality/measurement/update/judgement" + '/' + id,
                data: {
                    _token: "{{ csrf_token() }}",
                    id: id,
                    value: judgement
        ...
        function EditDiesApproval(xx) {
            $.get('/prod/modal-quality/diesapproval', {}, function(data, status) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $("form").attr("action",
                            "{{ url('/prod/modal-quality/diesapproval/update') }}");
        ...
        function EditSpectroHPDC(xx) {
            $.get('/prod/modal-quality/spectro-hpdc', {}, function(data, status) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $("form").attr("action",
                            "{{ url('/prod/modal-quality/spectro-hpdc/update') }}");
        ...
        function EditSpectroGDC(xx) {
            $.get('/prod/modal-quality/spectro-gdc', {}, function(data, status) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $("form").attr("action",
                            "{{ url('/prod/modal-quality/spectro-gdc/update') }}");
                        $("#furnace").val(data.furnace);
                        $("#furnace").trigger('change');
                        $("#a").val(data.a);
                        $("#aa").val(data.aa);
