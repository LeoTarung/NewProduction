...
@section('content')
    ...
    <div class="row mt-3">
        <div class="col">
            <button class="btn btn-sm btn-secondary mb-2 float-start" onclick="addQRCodeFG()"><i class="fa-solid fa-ban"></i>
                Abnormality</button>
        </div>
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="Table_PartFG"
                            class="table table-striped-columns table-hover table-bordered nowrap display"
    ...
    <script>
        ...
        function PrintQRFG(id) {
            ...
            if (!/^\d+$/.test(input)) {
                ...
                let newWin = window.open("{{ url('/qr/printQR') }}" + "/" + id + "/" + input + "/normal", "hello",
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#tambahaninputan").html(
                            ...
                            //     '</div>' +
                            '<input type="hidden" name="kode_customer" value="' + data
                            .kode_customer + '">' +
