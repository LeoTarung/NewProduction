        ...
        <div class="card-body">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="pills-measure-HPDC-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-measure-HPDC" type="button" role="tab"
                        aria-controls="pills-measure-HPDC" aria-selected="true">MEASURE HPDC</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-measure-GDC-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-measure-GDC" type="button" role="tab" aria-controls="pills-measure-GDC"
                        aria-selected="false">MEASURE GDC</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-measure-machining-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-measure-machining" type="button" role="tab"
                        aria-controls="pills-measure-machining" aria-selected="false">MEASURE MACHINING</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-spectro-hpdc-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-spectro-hpdc" type="button" role="tab"
                        aria-controls="pills-spectro-hpdc" aria-selected="false">SPECTRO HPDC</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-spectro-gdc-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-spectro-gdc" type="button" role="tab" aria-controls="pills-spectro-gdc"
                        aria-selected="false">SPECTRO GDC</button>
                </li>
            </ul>
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-measure-HPDC" role="tabpanel"
                    aria-labelledby="pills-measure-HPDC-tab" tabindex="0">
                    <div class="card">
                        <div class="card-header fw-bold font-monospace fs-5"><i class="fa-solid fa-paste"></i> Measurement
                            Part HPDC</div>
                        <div class="card-body">
                                ...
                                <table id="Table_Measurement"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">JUDGEM ENT</th>
                                        </tr>
                                    </thead>
                ...
                <div class="tab-pane fade" id="pills-measure-GDC" role="tabpanel" aria-labelledby="pills-measure-GDC-tab"
                    tabindex="0">
                    <div class="card">
                        <div class="card-header fw-bold font-monospace fs-5"><i class="fa-solid fa-paste"></i> Measurement
                            Part GDC</div>
                ...
                <div class="tab-pane fade" id="pills-measure-machining" role="tabpanel"
                    aria-labelledby="pills-measure-machining-tab" tabindex="0">
                    <div class="card">
                        <div class="card-header fw-bold font-monospace fs-5"><i class="fa-solid fa-paste"></i> Measurement
                            Part Machining</div>
                        <div class="card-body">
                ...
                <div class="tab-pane fade" id="pills-spectro-hpdc" role="tabpanel"
                    aria-labelledby="pills-spectro-hpdc-tab" tabindex="0">
                    <div class="card">
                ...
                <div class="tab-pane fade" id="pills-spectro-gdc" role="tabpanel"
                    aria-labelledby="pills-spectro-gdc-tab" tabindex="0">
                    <div class="card">
                        <div class="card-header fw-bold font-monospace fs-5"><i class="fa-solid fa-paste"></i>
                            Spectrometer GDC
                        </div>
