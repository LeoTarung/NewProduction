...
class CreateDbFromTimbanganIngot extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('db_fromtimbanganingot', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('db_fromtimbanganingot');
    }
}
